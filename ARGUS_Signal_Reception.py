...
# Generated: Sun Mar  3 11:51:50 2019
##################################################
...
class ARGUS_Signal_Reception(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.pluto_source_0 = iio.pluto_source('', int(carrier), int(samp_rate), int(data_rate), 0x8000, True, True, True, "manual", 64.0, '', True)
        ...
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_char*1, 'ARGUSdata.bin', False)
        ...
        self.connect((self.digital_psk_demod_1, 0), (self.blocks_file_sink_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.pluto_source_0.set_params(int(self.carrier), int(self.samp_rate), int(self.data_rate), True, True, True, "manual", 64.0, '', True)
