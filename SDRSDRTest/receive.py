...
# Title: Receive
# Generated: Wed Feb 20 14:07:01 2019
##################################################
...
class receive(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.pluto_source_0 = iio.pluto_source('ip:pluto.local', int(2500000000), int(samp_rate), int(freq), 0x8000, True, True, True, "manual", 64.0, '', True)
