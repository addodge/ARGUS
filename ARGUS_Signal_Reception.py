...
# Title: ARGUS_Signal_Reception
# Generated: Tue Jan 29 13:23:56 2019
##################################################
...
class ARGUS_Signal_Reception(gr.top_block, Qt.QWidget):
...
def main(top_block_cls=ARGUS_Signal_Reception, options=None):
